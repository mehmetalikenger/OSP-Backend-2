...
public class UserProfileController {
    ...
    public HttpStatus uploadProfilePicture(@PathVariable Long id, @RequestParam("file") MultipartFile file) {
        userProfileAppService.uploadProfilePicture(id, file);
        return HttpStatus.OK;
    }

    @DeleteMapping("/delete-account/{id}")
    public org.springframework.http.ResponseEntity<Void> deleteUserProfile(@PathVariable Long id) {
